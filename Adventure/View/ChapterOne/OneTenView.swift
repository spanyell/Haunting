...
struct OneTenView: View
{
    ...
    var body: some View
    {
        ...
        {
            NavigationLink(
                destination: OneElevenView(storyPlacement: 11), tag: 1, selection: $viewAction)
            {
                EmptyView()
            }
            NavigationLink(
            ...
            NavigationLink(
                destination: OneSixteenView(storyPlacement: 16, musicFile: Constants.POST_BATHROOM_MUSIC!), tag: 3, selection: $viewAction)
            {
                EmptyView()
            }
        }
